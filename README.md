...
- **https://services.eonfn.dev:2096/pakchunkChrono-WindowsClient.pak** - *(45.3 MB)*
- **https://services.eonfn.dev:2096/EonGameAssets.pak** - *(898 MB)*
- **https://services.eonfn.dev:2096/EonCosmetics.pak** - *(1.24 GB)*

## ++Eon+Release-17.50-CL-17388565-Windows
- **https://services.eonfn.dev:2096/z_pakchunkLowMesh-WindowsClient_P.ucas** - *(9.17 MB)*
- **https://services.eonfn.dev:2096/z_pakchunkLowMesh-WindowsClient_P.utoc** - *(28.0 KB)*
- **https://services.eonfn.dev:2096/z_pakchunkEon-WindowsClient_P.ucas** - *(1.12 MB)*
- **https://services.eonfn.dev:2096/z_pakchunkEon-WindowsClient_P.utoc** - *(4.00 KB)*

---

## Before You Download
> [!NOTE]
> - **`EonGameAssets`** and **`EonCosmetics`** both contain custom cosmetics. They were created in two different UProjects, so if you want all of the Eon cosmetics, download them both.
>
...
- **`WID_Assault_SemiAuto_Athena_UR_Ore_T03`** - **Enhanced Burst Assault Rifle** *(Mythic)*
- **`WID_Assault_RedDotAR_Athena_UR`** - **MK-Seven Assault Rifle** *(Mythic)*
...
- **`WID_Sniper_Heavy_Athena_UR_Ore_T03`** - **Enhanced Heavy Sniper Rifle** *(Mythic)*
